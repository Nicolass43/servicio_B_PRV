...
CREATE TABLE IF NOT EXISTS insumo_categoria(
    ...
    constraint fk_categoria_insumo_categoria foreign key (id_categoria) references categoria (id_categoria)
	   ...
	   /* INSERCION DATOS */
INSERT INTO proveedor VALUES (/*id*/ null , /*rut*/ '77980500-K', /*nombre fantasia*/	null, /*razon social */ 'CENTRO DE ERGONOMIA Y SALUD OCUPACI', 
...
(/* proveedor */ 44, /* categoria */ 9),
(/* proveedor */ 45, /* categoria */ 6),
(/* proveedor */ 46, /* categoria */ 3),
(/* proveedor */ 47, /* categoria */ 1),
...
(/* proveedor */ 65, /* categoria */ 9);
insert into proveedor_categoria (id_proveedor, id_categoria) values
(/* proveedor */ 66, /* categoria */ 8);
